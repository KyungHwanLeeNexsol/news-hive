...
### 13. 공시 충격 분석 (SPEC-AI-004, 진행 중)

- 공시 유형/규모별 예상 시장 충격 자동 계산
- 공시 후 실제 주가 반응 대비 미반영 갭 산출
- BriefingSignal에 사용된 AI 모델명 추적
...
- **개발 단계**: Phase 6 (AI 예측 고도화 + 사용자 인증)
- **배포 현황**: Oracle Cloud VM (백엔드) + Vercel (프론트엔드) 운영 중
- **스케줄러**: 9개 예약 작업 실행 중
- **데이터베이스**: PostgreSQL 16, Alembic 마이그레이션 36회 적용
- **SPEC 현황**: SPEC-AI-003 완료, SPEC-AI-004 진행 중
